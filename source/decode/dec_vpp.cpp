...
int main(int argc, char** argv)
{
    ...
    //7. Allocate surfaces for decoder and VPP In
    ...
    //8. Initialize the Media SDK decoder
    ...
    // ===============================================================
    //9. Start decoding the frames from the stream
    //
    mfxTime tStart, tEnd;
    mfxGetTime(&tStart);
